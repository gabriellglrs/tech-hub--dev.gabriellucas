...
> **Novo no módulo!** Acesse o **[MANUAL-EXPLOR/](MANUAL-EXPLOR/)** — checklist operacional das 7 fases da exploração (alimentado pelos Módulos 01 e 02): alimentação → vetores → brute force → cracking → exploração → validação → relatório. Siga cada fase na ordem.
